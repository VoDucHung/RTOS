...
void setup(){
  ...
  xTaskCreate(RTC,"RTC Task",4000,NULL,1,NULL);
  xTaskCreate(DHT,"DHT Task",4000,NULL,2,NULL);
  xTaskCreate(fastLED,"FastLED Task",4000,NULL,2,NULL);
  xTaskCreate(BUZZER,"BUZZER Task",4000,NULL,2,NULL);
  ...
  void SerialRead(void*){
    while(1){
        ...
        if( key == "I"){
          ...
          Serial.println("!!!!!!!!!!!!!!!!!!!!!Serial Access Critical-section-------------");
        }
        if(key == "O" ){     
          xSemaphoreGive(Sem);
          Serial.println("!!!!!!!!!!!!!!!!!!!!!Serial OUT Critical-section-------------");
